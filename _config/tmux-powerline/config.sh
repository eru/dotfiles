...
# date.sh {
    ...
    export TMUX_POWERLINE_SEG_DATE_FORMAT="%a %m/%d %H:%M"
# }
...
# mailcount.sh {
    ...
    export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/eru/.mail/inbox/new"
    ...
    export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/eru/.mailcheckrc"
# }
...
# now_playing.sh {
    ...
    # export TMUX_POWERLINE_SEG_NOW_PLAYING_TRACK_LOG_FILEPATH="/Users/eru/.now_playing.log"
